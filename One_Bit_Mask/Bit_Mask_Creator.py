...
file.write("#define " + REG_NAME + "_" + Bit_0  + "_MASK_" + "\t\t (0x00000001) \n")
file.write("#define " + REG_NAME + "_" + Bit_0  + "_CLEAR" + "\t\t (0xFFFFFFFE) \n")
file.write("#define " + REG_NAME + "_" + Bit_1  + "_MASK_" + "\t\t (0x00000002) \n")
file.write("#define " + REG_NAME + "_" + Bit_1  + "_CLEAR" + "\t\t (0xFFFFFFFD) \n")
file.write("#define " + REG_NAME + "_" + Bit_2  + "_MASK_" + "\t\t (0x00000004) \n")
file.write("#define " + REG_NAME + "_" + Bit_2  + "_CLEAR" + "\t\t (0xFFFFFFFB) \n")
file.write("#define " + REG_NAME + "_" + Bit_3  + "_MASK_" + "\t\t (0x00000008) \n")
file.write("#define " + REG_NAME + "_" + Bit_3  + "_CLEAR" + "\t\t (0xFFFFFFF7) \n")
file.write("#define " + REG_NAME + "_" + Bit_4  + "_MASK_" + "\t\t (0x00000010) \n")
file.write("#define " + REG_NAME + "_" + Bit_4  + "_CLEAR" + "\t\t (0xFFFFFFEF) \n")
file.write("#define " + REG_NAME + "_" + Bit_5  + "_MASK_" + "\t\t (0x00000020) \n")
file.write("#define " + REG_NAME + "_" + Bit_5  + "_CLEAR" + "\t\t (0xFFFFFFDF) \n")
file.write("#define " + REG_NAME + "_" + Bit_6  + "_MASK_" + "\t\t (0x00000040) \n")
file.write("#define " + REG_NAME + "_" + Bit_6  + "_CLEAR" + "\t\t (0xFFFFFFBF) \n")
file.write("#define " + REG_NAME + "_" + Bit_7  + "_MASK_" + "\t\t (0x00000080) \n")
file.write("#define " + REG_NAME + "_" + Bit_7  + "_CLEAR" + "\t\t (0xFFFFFF7F) \n")
file.write("#define " + REG_NAME + "_" + Bit_8  + "_MASK_" + "\t\t (0x00000100) \n")
file.write("#define " + REG_NAME + "_" + Bit_8  + "_CLEAR" + "\t\t (0xFFFFFEFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_9  + "_MASK_" + "\t\t (0x00000200) \n")
file.write("#define " + REG_NAME + "_" + Bit_9  + "_CLEAR" + "\t\t (0xFFFFFDFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_10 + "_MASK_" + "\t\t (0x00000400) \n")
file.write("#define " + REG_NAME + "_" + Bit_10 + "_CLEAR" + "\t\t (0xFFFFFBFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_11 + "_MASK_" + "\t\t (0x00000800) \n")
file.write("#define " + REG_NAME + "_" + Bit_11 + "_CLEAR" + "\t\t (0xFFFFF7FF) \n")
file.write("#define " + REG_NAME + "_" + Bit_12 + "_MASK_" + "\t\t (0x00001000) \n")
file.write("#define " + REG_NAME + "_" + Bit_12 + "_CLEAR" + "\t\t (0xFFFFEFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_13 + "_MASK_" + "\t\t (0x00002000) \n")
file.write("#define " + REG_NAME + "_" + Bit_13 + "_CLEAR" + "\t\t (0xFFFFDFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_14 + "_MASK_" + "\t\t (0x00004000) \n")
file.write("#define " + REG_NAME + "_" + Bit_14 + "_CLEAR" + "\t\t (0xFFFFBFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_15 + "_MASK_" + "\t\t (0x00008000) \n")
file.write("#define " + REG_NAME + "_" + Bit_15 + "_CLEAR" + "\t\t (0xFFFF7FFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_16 + "_MASK_" + "\t\t (0x00010000) \n")
file.write("#define " + REG_NAME + "_" + Bit_16 + "_CLEAR" + "\t\t (0xFFFEFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_17 + "_MASK_" + "\t\t (0x00020000) \n")
file.write("#define " + REG_NAME + "_" + Bit_17 + "_CLEAR" + "\t\t (0xFFFDFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_18 + "_MASK_" + "\t\t (0x00040000) \n")
file.write("#define " + REG_NAME + "_" + Bit_18 + "_CLEAR" + "\t\t (0xFFFBFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_19 + "_MASK_" + "\t\t (0x00080000) \n")
file.write("#define " + REG_NAME + "_" + Bit_19 + "_CLEAR" + "\t\t (0xFFF7FFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_20 + "_MASK_" + "\t\t (0x00100000) \n")
file.write("#define " + REG_NAME + "_" + Bit_20 + "_CLEAR" + "\t\t (0xFFEFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_21 + "_MASK_" + "\t\t (0x00200000) \n")
file.write("#define " + REG_NAME + "_" + Bit_21 + "_CLEAR" + "\t\t (0xFFDFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_22 + "_MASK_" + "\t\t (0x00400000) \n")
file.write("#define " + REG_NAME + "_" + Bit_22 + "_CLEAR" + "\t\t (0xFFBFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_23 + "_MASK_" + "\t\t (0x00800000) \n")
file.write("#define " + REG_NAME + "_" + Bit_23 + "_CLEAR" + "\t\t (0xFF7FFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_24 + "_MASK_" + "\t\t (0x01000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_24 + "_CLEAR" + "\t\t (0xFEFFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_25 + "_MASK_" + "\t\t (0x02000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_25 + "_CLEAR" + "\t\t (0xFDFFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_26 + "_MASK_" + "\t\t (0x04000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_26 + "_CLEAR" + "\t\t (0xFBFFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_27 + "_MASK_" + "\t\t (0x08000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_27 + "_CLEAR" + "\t\t (0xF7FFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_28 + "_MASK_" + "\t\t (0x10000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_28 + "_CLEAR" + "\t\t (0xEFFFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_29 + "_MASK_" + "\t\t (0x20000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_29 + "_CLEAR" + "\t\t (0xDFFFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_30 + "_MASK_" + "\t\t (0x40000000) \n")
file.write("#define " + REG_NAME + "_" + Bit_30 + "_CLEAR" + "\t\t (0xBFFFFFFF) \n")
file.write("#define " + REG_NAME + "_" + Bit_31 + "_MASK_" + "\t\t (0x80000000) \n")
